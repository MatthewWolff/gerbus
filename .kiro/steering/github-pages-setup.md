...
2. **Push the basic setup files and congfigurations**
3. **Run the command** `gh-pages -d dist` to establish the `gh-pages` branch
4. **Update settings to allow main to build**
   - Settings > Actions > General > Workflow Permissions > Enable: Read and Write Permissions > Save
